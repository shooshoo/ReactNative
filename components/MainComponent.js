...
class Main extends Component {
    ...
    NetInfo.fetch().then((connectionInfo) => {
            ...
            console.log("Detail : ", connectionInfo.details);
            console.log("isInternetReachable : ", connectionInfo.isInternetReachable);
            ToastAndroid.show('Initial Network Connectivity Type: ' + connectionInfo.type + ', isInternetReachable: ' + connectionInfo.isInternetReachable, ToastAndroid.LONG)
          });
